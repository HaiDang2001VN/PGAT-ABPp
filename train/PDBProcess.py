...
def read_files(folder_path, label):
    ...
    for filename in os.listdir(folder_path):
        ...
        pdb_entry = {"filename": filename, "A": A_str, "seq": seq, "label": label}
        data.append(pdb_entry)
    return data


CMAP_THRESH = 10  # define cmap_thresh
positive_folder = "/Users/duc.bui/Documents/BHD/test/PGAT-ABPp/dataset/main dataset/abp"  # path to ABPs files
negative_folder = "/Users/duc.bui/Documents/BHD/test/PGAT-ABPp/dataset/main dataset/nonabp"  # path to non-ABPs files
...
df.to_csv(
    "./example_data/data.csv", index=False
)  # path to your prepared data_to_load folder
